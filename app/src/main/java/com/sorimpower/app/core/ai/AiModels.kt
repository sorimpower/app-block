...
internal enum class AiTaskType {
    BODY_LOG_PROGRESS_ANALYSIS, BODY_LOG_DAILY_CALORIE_ANALYSIS, BODY_LOG_INBODY_EXTRACTION, HEALTH_CHECKUP_PAGE_SELECTION, HEALTH_CHECKUP_EXTRACTION,
    ...
    PROPERTY_TAX_SCENARIO_COMPARISON, PERSPECTIVE_TOPIC_SUGGESTION, PERSPECTIVE_METADATA_ANALYSIS,
}
