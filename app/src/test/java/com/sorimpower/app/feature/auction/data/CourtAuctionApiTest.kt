...
class CourtAuctionApiTest {
    ...
    fun `법원 원본 구성행을 하나의 경매 물건으로 묶고 값을 정규화한다`() {
        val first = targetRow().copy(notifiedMinimumPrice = 800_000_000L)
        ...
        with(items.single()) {
            ...
            assertEquals(800_000_000L, minimumPrice)
