...
> 버전: `v0.14.16` · 최소 Android 8.0(API 26) · target SDK 35
...
- 실제 관심 비중과 최근 탐색 경로 중심 홈, 영상 썸네일이 포함된 주제별 생각 흐름 지도
- 생각 흐름 지도, 생각이 넓어진 기록, 주간 시청 요약
...
- 아직 분석하지 않은 사건을 대상으로 한 매일 아침 AI 맞춤 추천 및 로컬 알림
